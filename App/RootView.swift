    ...
    var body: some View {
        ZStack(alignment: .bottom) {
            ...
            ZStack {
                ...
                case .arGarden(let plant, let iter): ARGardenView(plant: plant, overrideIteration: iter)
                case .arPreview(let plant):   PlantUnlockView(plant: plant, isPreviewMode: true)
